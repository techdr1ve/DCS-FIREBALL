...
VSN_TornadoIDS =  {
		...
		Name 			= 'VSN_TornadoIDS',--AG
		DisplayName		= _('Panavia Tornado IDS'),--AG
        Picture 		= "Tornado_IDS.png",
        Rate 			= "50",
        Shape			= "VSN_TornadoIDS",		
        WorldID			=  WSTYPE_PLACEHOLDER, 
        
	shape_table_data 	= 
	{
		{
			file  	 	= 'VSN_TornadoIDS';--AG
			life  	 	= 20; -- lifebar
			vis   	 	= 3; -- visibility gain.
			desrt    	= 'tornado-oblomok'; -- Name of destroyed object file name
			fire  	 	= { 300, 2}; -- Fire on the ground after destoyed: 300sec 2m
			username	= 'VSN_TornadoIDS';--AG
	...
	Pylons =     {
        ...
        pylon(2, 0, -1.280000, -0.486000, -2.018000,
            ...
            },
            {
                ...
                { CLSID = "{7210496B-7B81-4B52-80D6-8529ECF847CD}" },--Kormoran
...
--]]		
        ...
        pylon(7, 1, 1.342000, -1.003000, 0.550000,
            {
        ...
        pylon(8, 1, -0.155000, -1.003000, 0.550000,
            {
...
--	    aircraft_task(RunwayAttack),
	...
	DamageParts = 
	{  
		[1] = "VSN_TornadoIDS-oblomok-wing-r", -- wing R
		[2] = "VSN_TornadoIDS-oblomok-wing-l", -- wing L
	},
...
add_aircraft(VSN_TornadoIDS) --AG
