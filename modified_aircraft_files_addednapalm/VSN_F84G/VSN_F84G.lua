function m3_f84(tbl)--12.7mm M3 Browning
...
VSN_F84G =  {
		...
		Name 			= 'VSN_F84G',
		DisplayName		= _('F-84G Thunderjet'),
        Picture 		= "VSN_F84G.png",
	...
	{
		{
			...
			desrt    	= 'VSN_F84G-oblomok'; -- Name of destroyed object file name
		...
		{
			name  		= "VSN_F84G-oblomok";
			file  		= "VSN_F84G-oblomok";
			fire  		= { 240, 2};
		},
	},
	...
	Categories= {"{78EFB7A2-FD52-4b57-A6A6-3BF0E1D6555F}", "Interceptor",},
		...
		nose_gear_pos 				                = {4.261,	-1.880,	0},   -- nosegear coord 
	    nose_gear_amortizer_direct_stroke   		=  0,      -- down from nose_gear_pos !!!
	    nose_gear_amortizer_reversal_stroke  		=  -0.07,  -- up 
	    nose_gear_amortizer_normal_weight_stroke 	=  -0.03,   -- up 
	    nose_gear_wheel_diameter 	                =  0.520, -- in m
	
	    main_gear_pos 						 	    = {-0.800,	-1.640,	1.264}, -- main gear coords 
	    main_gear_amortizer_direct_stroke	 	    =   0,     --  down from main_gear_pos !!!
	    main_gear_amortizer_reversal_stroke  	    =   -0.07, --  up 
	    main_gear_amortizer_normal_weight_stroke    =   -0.04,-- down from main_gear_pos
	...
	--]]
		...
		crew_members = 
		{
			[1] = 
			{
				...
				drop_canopy_name   	= "VSN_F84G-fonar",
		...
		--[[
		effects_presets = {
			{effect = "OVERWING_VAPOR", file = current_mod_path.."/Effects/VSN_F84G_overwingVapor.lua"},
		},
		--]]
...
--pylons_enumeration = {1, 11, 10, 2, 3, 9, 4, 8, 5, 7, 6},
	...
	Pylons =     {
        ...
        pylon(2, 0, 0, 0, 0,
			...
			{
				{ CLSID = "{PTB_F84G}"	,arg_increment = 1.0,required = {{station = 10,loadout = {"{PTB_F84G}" ,arg_increment = 1.0}}} },
			}
        ),
        pylon(3, 0, 0, 0, 0,
			{
        ...
        pylon(10, 0, 0, 0, 0,
			...
			{
				{ CLSID = "{PTB_F84G}"	,arg_increment = 1.0,required = {{station = 2,loadout = {"{PTB_F84G}"	,arg_increment = 1.0}}} },
			}
        ),
		pylon(11, 2, 0, 0, 0,
			{
	...
	DamageParts = 
	{  
		[1] = "VSN_F84G-oblomok-wing-r", -- wing R
		[2] = "VSN_F84G-oblomok-wing-l", -- wing L
	},
...
add_aircraft(VSN_F84G) 


local function PTB_F84G(clsid, center) -- It increased the capacity of the tip tank to 230 gallons. 1050 Liter?
	local data = {
