...
VSN_MirageIIIC_AG =  {
		...
		Name 			= 'VSN_MirageIIIC_AG',--AG
		DisplayName		= _('Mirage IIIC AG'),--AG
        Picture 		= "VSN_MirageIII.png",
        Rate 			= "50",
        Shape			= "VSN_MirageIIIC_AG",--AG	
        WorldID			=  WSTYPE_PLACEHOLDER, 
        
	shape_table_data 	= 
	{
		{
			file  	 	= 'VSN_MirageIIIC_AG';--AG
			life  	 	= 20; -- lifebar
			vis   	 	= 3; -- visibility gain.
			desrt    	= 'VSN_MirageIII-oblomok'; -- Name of destroyed object file name
			fire  	 	= { 300, 2}; 			-- Fire on the ground after destoyed: 300sec 2m
			username	= 'VSN_MirageIIIC_AG';--AG
...
add_aircraft(VSN_MirageIIIC_AG) --AG
