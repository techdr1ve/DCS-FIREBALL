	...
	if Position == "IN" then
		StationLoad = {
			...
			{ CLSID	= "{AB8B8299-F1CC-4359-89B5-2172E0CF4A5A}" },	-- Mk-84
    			...
    			{ CLSID = "BIN_200", required = {{station = 2,loadout = {"BIN_200"}}} },	-- BIN-200
	...
	elseif Position == "ST" then
		StationLoad = {
			...
			{ CLSID	= "{AB8B8299-F1CC-4359-89B5-2172E0CF4A5A}" },	-- Mk-84
    			{ CLSID = "{mk77mod0}"},                             -- Mk-77mod0 750 lb petroleum oil bomb
    			{ CLSID = "{mk77mod1}"},                             -- Mk-77mod1 500 lb petroleum oil bomb
    			{ CLSID = "BIN_200", required = {{station = 1,loadout = {"BIN_200"}}} },	-- BIN-200
	...
	elseif Position == "CL" then
		StationLoad = {
			...
			{ CLSID	= "{AB8B8299-F1CC-4359-89B5-2172E0CF4A5A}" },	-- Mk-84
    			{ CLSID = "{mk77mod0}"},                             -- Mk-77mod0 750 lb petroleum oil bomb
    			{ CLSID = "{mk77mod1}"},                             -- Mk-77mod1 500 lb petroleum oil bomb
    			{ CLSID = "BIN_200", required = {{station = 3,loadout = {"BIN_200"}}} },	-- BIN-200
			{ CLSID = "{1C97B4A0-AA3B-43A8-8EE7-D11071457185}"}, -- 6 * MER MK82
			{ CLSID	=	"{3C7CD675-7D39-41C5-8735-0F4F537818A8}"}, -- 6 * MK20
			{ CLSID = "{60CC734F-0AFA-4E2E-82B8-93B941AB11CF}" }, -- TER 3*MK82
			{ CLSID = "{BRU-42_3*Mk-82AIR}" }, -- TER 3 MK82
