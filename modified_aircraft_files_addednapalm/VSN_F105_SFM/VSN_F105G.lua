...
--	{ CLSID = "LAU-115_2*LAU-127_AIM-9L"				,arg_increment = 0.0},-- LAU-115 2xAIM-9L
	...
	{ CLSID = "{VSN_F105_LAU105_AIM9P}"	,arg_increment = 0.0}, --LAU-105 2*AIM-9P
...
local centerline 	= {
	...
	{ CLSID = "{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}" ,arg_increment = 0.0}, -- Mk83
    	{ CLSID = "{mk77mod0}",arg_increment = 0.0 },                             -- Mk-77mod0 750 lb petroleum oil bomb
    	{ CLSID = "{mk77mod1}",arg_increment = 0.0 },                             -- Mk-77mod1 500 lb petroleum oil bomb
    	{ CLSID = "BIN_200",arg_increment = 0.1, required = {{station = 3,loadout = {}}} },	-- BIN-200
	--{ CLSID = "{752B9781-F962-11d5-9190-00A0249B6F00}" ,arg_increment = 0.0},
...
VSN_F105G =  {
		...
		Name 			= 'VSN_F105G',--AG
		DisplayName		= _('F-105G Thunderchief'),-- Republic F-105 Thunderchief
	...
	--]]
		...
		crew_members = 
		{
			...
			[2] = 
			{
				ejection_seat_name	=	17,
				pilot_name			= 	19,
				drop_canopy_name	=	"VSN_F105G_fonar2";
				pos = 	{4.126,	1.145,	0},
				ejection_order    = 1,
			}, -- end of [1]
		}, -- end of crew_members
