	...
	Pylons =     {
        ...
        pylon(2, 0, -1.200, 0.000, -3.47000,
		 ...
		 pylon(4, 0, -0.800, -0.310, -1.900,
            ...
            },
            {
				...
				--{ CLSID = "{BRU33_2*LAU68_M282}", arg_value = 0.0},--OpenBeta Versuch 2xMK282 Hydrasx19
				{ CLSID = "{BRU33_2*LAU68}", arg_value = 0.0}, --OpenBeta 2xM68 Lau 151 Hydrax19
				{ CLSID = "{BRU33_2*LAU68_MK5}", arg_value = 0.0}, --OpenBeta 2xM68 Lau 151 Hydrax19 MK V
				{ CLSID = "{BRU33_2*LAU61}", arg_value = 0.0}, --Open Beta 2xHydra Mk61
				--{ CLSID = "{BRU33_2*LAU10}", arg_value = 0.0}, --OpenBeta 2xHydra LAU10
                --{ CLSID	= "{6CEB49FC-DED8-4DED-B053-E1F033FF72D3}", arg_value = 0.5}, -- AIM-9M
				...
				{ CLSID = "{BRU42_2*MK81 LS}", arg_value = 0.0}, --  BRU42 2xMk-81 //Bean  
        ...
        use_full_connector_position = true,
			...
			},
			{
				...
				--{ CLSID = "{VSN_F104_LAU105_AIM9L}", arg_value = 0.5}, --Lau105 2x Aim-9L
				{ CLSID = "{VSN_F104_LAU115C_AIM9L}",arg_value = 0.5}, --LAU-115 2*AIM-9
				{ CLSID = "{VSN_F104_LAU115C_AIM9P}",arg_value = 0.5}, --LAU-115 2*AIM-9
		...
		pylon(8, 0, -0.800, -0.310, 1.900,
            ...
            },
            {
				...
				{ CLSID = "{7A44FF09-527C-4B7E-B42B-3F111CFE50FB}", arg_value = 0.0}, -- MK-83
    				{ CLSID = "{mk77mod0}",arg_value  = 0.0 },                             -- Mk-77mod0 750 lb petroleum oil bomb
    				{ CLSID = "{mk77mod1}",arg_value  = 0.0 },                             -- Mk-77mod1 500 lb petroleum oil bomb
    				{ CLSID = "BIN_200",arg_value  = 0.1, required = {{station = 8,loadout = {}}} },	-- BIN-200
				{ CLSID = "{A021F29D-18AB-4d3e-985C-FC9C60E35E9E}", arg_value = 0.0}, -- LAU-68 7xHE Rockets
				{ CLSID = "{FD90A1DC-9147-49FA-BF56-CB83EF0BD32B}", arg_value = 0.0}, -- LAU-61 19xHE Rockets
				--{ CLSID = "{BRU33_2*LAU61_M282}", arg_value = 0.0},--Neuer Versuch mit 2xMK282 Hydrasx19
				--{ CLSID = "{BRU33_2*LAU68_M282}", arg_value = 0.0},--OpenBeta Versuch 2xMK282 Hydrasx19
